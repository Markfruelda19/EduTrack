...
-- Default teacher: username=teacher1, password=Teacher@1234
-- Hashes are generated by PHP password_hash($pass, PASSWORD_BCRYPT)
-- Run auth/seed_users.php once after import to insert real hashed accounts.
