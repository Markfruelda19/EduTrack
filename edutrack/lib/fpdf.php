...
protected function _getcorefontdata($family, $style)
{
    // Standard character widths for core PDF fonts (no file needed)
    $helvetica_widths = array(
...
public function AddFont($family, $style='', $file='', $dir='')
{
	...
	if(isset($this->fonts[$fontkey]))
		return;
	// Short-circuit for built-in core fonts — no file loading needed
	if(in_array($family, $this->CoreFonts) && $family!='symbol' && $family!='zapfdingbats')
	{
		$cw = $this->_getcorefontdata($family, $style);
		$info = array(
